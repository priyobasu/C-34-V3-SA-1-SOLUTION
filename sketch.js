...
function setup() 
{
  ...
  button.position(100,90); //change 1
  button.size(50,50);
  button.mouseClicked(drop);

   //btn 2
   button2 = createImg('cut_btn.png');
   button2.position(450,90); //change 2
   button2.size(50,50);
   button2.mouseClicked(drop2);
 
   rope = new Rope(7,{x:120,y:90});// change 3
   rope2 = new Rope(7,{x:490,y:90});// change 4
  ...
  ground = new Ground(300,height,width,20);// change 6
  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(200,height-80,100,100);//change 7
  bunny.scale = 0.2;
